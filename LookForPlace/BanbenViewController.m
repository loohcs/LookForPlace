...
- (void)viewDidLoad
{
    ...
    [scrollV setContentSize:CGSizeMake(0, 830
                                       )];
    [self.view addSubview:scrollV];
    UIImageView *imageV=[[UIImageView alloc] initWithFrame:CGRectMake(0, 0, 320, 870)];
    [imageV setImage:[UIImage imageNamed:@"版本信息7.png"]];
